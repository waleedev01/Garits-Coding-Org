...
INSERT INTO `Customer` VALUES (1,'Transco Gas Supplies Methane Buildings','Jack','Varta','Sulphur Lane, Stenchville','PR10EQ','Bucks','004479834387855','004479834387855','john.smith@outlook.com',1,1),(2,'','Mario','Smith','2 Palace Road','PR30EQ','London','004479834387333','004479834387855','mario@outlook.com',1,1),(3,'','Joanna','Brown','3 Palace Road','PR20EQ','London','004479834387555','004479834387855','JOnna.brown@outlook.com',NULL,NULL),(4,'','Cristiano','Ronaldo','Palace Road','PR10EQ','London','004479834387888','004479834387855','CR7@outlook.com',NULL,2),(5,'','Elizabeth','Smith','5 Palace Road','PR80EQ','London','004479834387766','004479834387855','EL@outlook.com',NULL,0),(6,'','Pablo','Escobar','6 Palace Road','PR30EQ','London','004479834365455','004479834387855','Pablito@outlook.com',NULL,NULL),(7,'','Flixbus','Ltd','Northampton Square,','EC1V 0HB','Manchester','004479834432155','004479834387855','flixbus@flixbus.com',NULL,NULL),(8,'','Premi','LTD','10 Winter Road','PA20FQ','Brighton','004479834383855','004479834387855','premi@premi.com',NULL,NULL),(9,'','Diego','Maradona','2089 Palace Road','PR30EQ','London','004479834327855','004479834387855','DMbest@outlook.com',NULL,NULL),(10,'','Steev','will','22 Palace Road','PR10EQ','London','004479834387859','004479834387855','stivi@outlook.com',NULL,NULL),(12,'','William','Gates','World Domination House, Enormous Street','NW10 4AT','Richville','0666 666 666','0207 477 3333','',NULL,NULL),(20,'','John','Doherty','Unknown Street, Whichville','MT1 2UP','Nowhereshire','07070 070 707','0101 010 0101','',NULL,NULL);
...
INSERT INTO `Discount` VALUES (1,'flexible',6),(2,'fixed',100);
...
INSERT INTO `Payment` VALUES (6,61,'cash','2022-04-10'),(7,62,'cash','2022-04-10'),(8,63,'cash','2022-04-10'),(9,67,'cash','2022-04-10'),(10,69,'card','2022-04-10');
...
INSERT INTO `Stock` VALUES (1,'Tyre, heavy tread',1,'2006',45,'Ford','Fjord Transit Van',6,20),(2,'Exhaust, complete box',10,'2020',200,'Fjord Estate','any',2,NULL),(3,'Engine Mounts, set',6,'2019',15,'Ford','all makes',4,NULL),(4,'Spark Plugs, each',22,'2006',1.5,'Ford','all makes',20,NULL),(5,'Spark Leads, set',16,'2006',12.5,'Mercedes-benz','all makes',10,NULL),(6,'Distributor Cap',10,'2006',35,'Ford','Fjord',5,NULL),(7,'Paint',3,'2006',60,'Slap-it-on Paints','all makes ',2,NULL),(8,'Interior Bulb',1,'2006',118,'Switch-it-on','Rolls Royce',1,NULL),(9,'Motor Oil',29,'2006',25,'BMW','all makes',25,NULL),(10,'Oil Filter',16,'2006',10,'Bmw','all makes',15,NULL),(11,'Air Filter',15,'2006',15,'Bmw','all makes',10,NULL);
...
INSERT INTO `Stock_ordered` VALUES (1,1,'2022-04-09',10),(1,1,'2022-04-10',20);
...
INSERT INTO `Stock_used` VALUES (3,1,'2022-04-10'),(3,4,'2022-04-10'),(21,2,'2022-04-10'),(22,2,'2022-04-10'),(23,2,'2022-04-10'),(24,1,'2022-04-10'),(25,2,'2022-04-10'),(26,2,'2022-04-10'),(27,2,'2022-04-10'),(28,1,'2022-04-10'),(29,9,'2022-04-10'),(30,8,'2022-04-10');
...
INSERT INTO `Task_performed` VALUES (3,1,'2022'),(3,3,'2022-04-10'),(5,1,'2022');
...
-- Dump completed on 2022-04-10 21:50:06
